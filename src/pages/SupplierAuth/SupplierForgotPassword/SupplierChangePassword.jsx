...
import { supplierForgotPasswordSetNewPassword } from "../../../redux/actions/supplierAuthAction";
...
function SupplierChangePassword() {
    ...
    const { loading, otpSend, otpVerify } = useSelector((state) => state.supplierAuthReducer);
    ...
    const handleSavePassword = async (e) => {
        ...
        try {
            if (!password) {
                ...
                dispatch(supplierForgotPasswordSetNewPassword(location?.state?.email, password, navigate));
            }
        } catch (error) {
