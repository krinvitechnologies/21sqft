...
import { supplierForgotPasswordSendOtp } from "../../../redux/actions/supplierAuthAction";

function SupplierVerifyEmail() {
    ...
    const handleLogin = async (e) => {
        try {
            ...
            if (!email) {
                ...
                const response = await dispatch(supplierForgotPasswordSendOtp(email, navigate));
        ...
        <div className="forgot-password">
            ...
            <div className="right-ufp">
                <div className="right-top-ufp">
                    <div>
                        <Link to="/supplier/login" className="ufp-link">
                            Back
                        </Link>
                    </div>
...
export default SupplierVerifyEmail;
